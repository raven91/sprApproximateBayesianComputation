...
#ifndef SPRAPPROXIMATEBAYESIANCOMPUTATION_EXPERIMENTALPARAMETERSET_HPP
#define SPRAPPROXIMATEBAYESIANCOMPUTATION_EXPERIMENTALPARAMETERSET_HPP
...
class ExperimentalParameterSet : public AbstractParameterSet
{
 public:

  ExperimentalParameterSet();
  ~ExperimentalParameterSet();
  ...
  const std::string &GetExperimentalDataFolderName();
  ...
  void Set_first_image(int first_image);
  void Set_last_image(int last_image);
 ...
 private:
  ...
  std::string experimental_data_folder_name_;
  std::string experimental_configuration_file_name_;
  ...
  void InitializeDependentParameters();
...
#endif //SPRAPPROXIMATEBAYESIANCOMPUTATION_EXPERIMENTALPARAMETERSET_HPP
